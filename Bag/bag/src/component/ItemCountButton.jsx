...
function CounterButton() {
  ...
  return <div className={[styles.countContainer]}>
    <button className={`btn btn-danger ${styles.incButton, styles.buttons}`} onClick={decreaseCounter}>-</button>
    <h3>{`${count}`}</h3>
    <button className={` btn btn-success ${styles.decButton, styles.buttons}`} onClick={incrementFunciton}>+</button>
  </div>
